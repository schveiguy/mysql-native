...
debug(MYSQLN_TESTS)
{
	void initBaseTestTables(bool doSafe)(Connection cn)
	{
...
@system unittest
{
	...
	{
		mixin(doImports(doSafe, "prepared", "commands", "connection"));
...
@system unittest
{
	...
	{
		mixin(doImports(doSafe, "result", "prepared", "connection", "commands"));
		mixin(scopedCn);
...
@system unittest
{
	static void test(bool doSafe)()
	{
		mixin(doImports(doSafe, "prepared", "commands", "connection", "result"));
		mixin(scopedCn);
...
@system unittest
{
	static void test(bool doSafe)()
	{
		mixin(doImports(doSafe, "commands", "connection", "result"));
		mixin(scopedCn);
